                    ...
                    >
                        ...
                        <div className={'pt-9'}>
                            ...
                            <Plus
                                ...
                                className={
                                    'relative transition-all ease-in duration-170 active:scale-85 cursor-pointer hover:bg-[#d59c28] left-13 sm:left-34 sm:top-1 p-2 bg-[#FFA800] text-white rounded-[50%]'
                                }
                                size={35}
                            />
                        </div>
